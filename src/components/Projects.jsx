  ...
  const projectData = [
    {
      ...
      description:
        "Developing an IoT-based health monitoring system for real-time SpO₂, heart rate, BMI, and ECG tracking and also booking appointment for Doctor.",
    ...
    },
    {
      title: "🌐 FindGit",
      description:
        "Explore GitHub profiles effortlessly. View detailed information about repositories, followers, and more.",
    ...
    },
    {
      ...
      description:
        "The application dynamically displays questions, evaluates responses in real-time, and showcases scores at the end of the quiz.",
    ...
    },
    {
      ...
      description:
        "Generate secure, customizable passwords with this web tool.",
    ...
    },
    {
      ...
      description:
        "A dynamic travel website using React and Tailwind CSS, enabling users to explore various destinations with key details such as name, price, and description.",
    ...
    },
    {
      ...
      description:
        "A simple yet powerful Text-to-Speech Converter using SpeechSynthesisUtterance() API.",
    ...
    },
    {
      ...
      description:
        "A Weather Application designed to make accessing real-time weather information intuitive, reliable, and effortless.",
    ...
    },
    {
      ...
      description:
        "A responsive Tic-Tac-Toe game with a dynamic stopwatch, seamless gameplay, and engaging UX/UI.",
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setVisibleProjects((prev) =>
        prev < projectData.length ? prev + 1 : prev
      );
    }, 300);
    return () => clearInterval(timer);
  }, [projectData.length]);
        ...
        <div className="text-center mb-16">
          <CodeBlock className="max-w-4xl mx-auto mb-8">
            <div className="text-cyan-400">
              ...
              <span className="text-green-400">'./premanshu-portfolio'</span>;
            </div>
            <div className="text-cyan-400">
              ...
              <span className="text-blue-400">Projects</span>.
              <span className="text-cyan-400">getAllProjects</span>();
            </div>
            <div className="text-cyan-400">
              <span className="text-gray-500">3</span>{" "}
              <span className="text-blue-400">showcase</span>.
              <span className="text-cyan-400">render</span>(
              <span className="text-green-400">'incredible-applications'</span>
              );
            </div>
          </CodeBlock>
          ...
          <h2 className="text-4xl sm:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-8">
            ...
            Latest{" "}
            <span className="text-orange-400 animate-pulse">Projects</span>
          </h2>
            ...
            >
              <div className="relative bg-gray-900/90 backdrop-blur-sm rounded-lg border border-cyan-400/30 overflow-hidden h-full flex flex-col min-h-[600px]">
                ...
                <div className="p-4 flex-1 flex flex-col">
                  <h3
                    className={`text-lg font-bold mb-3 bg-gradient-to-r ${project.color} bg-clip-text text-transparent`}
                  >
                    {project.title}
                  </h3>
        ...
        <div className="mt-16 text-center">
          <CodeBlock className="max-w-5xl mx-auto">
            <div className="text-cyan-400 space-y-1">
              <div>
                <span className="text-gray-500">$</span> git commit -m{" "}
                <span className="text-yellow-400">
                  "Added amazing projects to portfolio"
                </span>
              </div>
              <div className="text-green-400">
                ✅ Successfully deployed {projectData.length} projects to
                production! 🎉
              </div>
              <div className="text-cyan-400">
                🔗 Each project represents hours of coding, debugging, and
                innovation ⚡
              </div>
              <div className="text-purple-400">
                🚀 Ready to build the next big thing together! Let's
                collaborate! 💫
              </div>
            </div>
          </CodeBlock>
